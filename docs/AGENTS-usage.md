...
`AGENTS.md` sits at the repo root. When an AI coding agent starts a session, it reads the file first and loads:
...
**Greenfield projects (from scratch):** when the target repo is empty (or
